            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:flex flex-col text-left">
                  <span className="text-xs font-bold text-slate-900 leading-tight">Anurag</span>
                  <span className="text-[10px] text-slate-500 leading-tight">Lead Educator</span>
                </div>
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-slate-200 py-1.5 z-50 animate-in fade-in zoom-in-95 duration-150">
                  <div className="px-3.5 py-2 border-b border-slate-100">
                    <p className="text-xs font-bold text-slate-900">Anurag</p>
                    <p className="text-[11px] text-slate-500 truncate">anurag@institution.edu</p>
                  ...
                  <div className="py-1">
                    <button
                      onClick={() => {
                        ...
                        onTabChange && onTabChange('Students');
                      }}
          ...
          <div className="md:hidden border-t border-slate-200 py-3 space-y-1">
            ...
            {navItems.map((item) => (
              <button
                key={item.name}
                onClick={() => {
                  onTabChange && onTabChange(item.name);
